...
@interface Deathby_ViewController ()

@end

@implementation Deathby_ViewController
...
- (void)viewDidLoad {
    ...
    txt_counter.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"00:00" attributes:@{NSForegroundColorAttributeName: color}];
...
-(IBAction)start
{
    ...
    else
    {
        ...
        DeathTimer_ViewController *timescreen = [work instantiateViewControllerWithIdentifier:@"DeathTimer_ViewController"];
        ...
        [ApplicationDelegate.dic_result setObject:@"DEATH BY" forKey:@"workout_name"];
        ...
        [ApplicationDelegate.dic_result setObject:@"0" forKey:@"reps"];
